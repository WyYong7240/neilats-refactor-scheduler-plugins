...
func (in *NeilatsRefactorSchedulerArgs) DeepCopyInto(out *NeilatsRefactorSchedulerArgs) {
	*out = *in
	...
	if in.KubeNodeAddressAndSecret != nil {
		in, out := &in.KubeNodeAddressAndSecret, &out.KubeNodeAddressAndSecret
		*out = make(map[string]UserAddressSecretMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NeilatsRefactorSchedulerArgs.
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserAddressSecretMap) DeepCopyInto(out *UserAddressSecretMap) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserAddressSecretMap.
func (in *UserAddressSecretMap) DeepCopy() *UserAddressSecretMap {
	if in == nil {
		return nil
	}
	out := new(UserAddressSecretMap)
	in.DeepCopyInto(out)
	return out
}
