...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NeilatsRefactorSchedulerArgs)(nil), (*config.NeilatsRefactorSchedulerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_NeilatsRefactorSchedulerArgs_To_config_NeilatsRefactorSchedulerArgs(a.(*NeilatsRefactorSchedulerArgs), b.(*config.NeilatsRefactorSchedulerArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NeilatsRefactorSchedulerArgs)(nil), (*NeilatsRefactorSchedulerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NeilatsRefactorSchedulerArgs_To_v1_NeilatsRefactorSchedulerArgs(a.(*config.NeilatsRefactorSchedulerArgs), b.(*NeilatsRefactorSchedulerArgs), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*UserAddressSecretMap)(nil), (*config.UserAddressSecretMap)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_UserAddressSecretMap_To_config_UserAddressSecretMap(a.(*UserAddressSecretMap), b.(*config.UserAddressSecretMap), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.UserAddressSecretMap)(nil), (*UserAddressSecretMap)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_UserAddressSecretMap_To_v1_UserAddressSecretMap(a.(*config.UserAddressSecretMap), b.(*UserAddressSecretMap), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_NeilatsRefactorSchedulerArgs_To_config_NeilatsRefactorSchedulerArgs(in *NeilatsRefactorSchedulerArgs, out *config.NeilatsRefactorSchedulerArgs, s conversion.Scope) error {
...
// Convert_v1_NeilatsRefactorSchedulerArgs_To_config_NeilatsRefactorSchedulerArgs is an autogenerated conversion function.
func Convert_v1_NeilatsRefactorSchedulerArgs_To_config_NeilatsRefactorSchedulerArgs(in *NeilatsRefactorSchedulerArgs, out *config.NeilatsRefactorSchedulerArgs, s conversion.Scope) error {
	return autoConvert_v1_NeilatsRefactorSchedulerArgs_To_config_NeilatsRefactorSchedulerArgs(in, out, s)
}

func autoConvert_config_NeilatsRefactorSchedulerArgs_To_v1_NeilatsRefactorSchedulerArgs(in *config.NeilatsRefactorSchedulerArgs, out *NeilatsRefactorSchedulerArgs, s conversion.Scope) error {
	out.PrometheusAddress = in.PrometheusAddress
	out.NetworkDevice = *(*map[string]string)(unsafe.Pointer(&in.NetworkDevice))
	out.StorageDevice = *(*map[string]string)(unsafe.Pointer(&in.StorageDevice))
	out.EnableSLA = in.EnableSLA
...
// Convert_config_NeilatsRefactorSchedulerArgs_To_v1_NeilatsRefactorSchedulerArgs is an autogenerated conversion function.
func Convert_config_NeilatsRefactorSchedulerArgs_To_v1_NeilatsRefactorSchedulerArgs(in *config.NeilatsRefactorSchedulerArgs, out *NeilatsRefactorSchedulerArgs, s conversion.Scope) error {
	return autoConvert_config_NeilatsRefactorSchedulerArgs_To_v1_NeilatsRefactorSchedulerArgs(in, out, s)
}
...
func autoConvert_v1_UserAddressSecretMap_To_config_UserAddressSecretMap(in *UserAddressSecretMap, out *config.UserAddressSecretMap, s conversion.Scope) error {
	out.NodeAddress = in.NodeAddress
	out.NodeSecret = in.NodeSecret
	return nil
}

// Convert_v1_UserAddressSecretMap_To_config_UserAddressSecretMap is an autogenerated conversion function.
func Convert_v1_UserAddressSecretMap_To_config_UserAddressSecretMap(in *UserAddressSecretMap, out *config.UserAddressSecretMap, s conversion.Scope) error {
	return autoConvert_v1_UserAddressSecretMap_To_config_UserAddressSecretMap(in, out, s)
}

func autoConvert_config_UserAddressSecretMap_To_v1_UserAddressSecretMap(in *config.UserAddressSecretMap, out *UserAddressSecretMap, s conversion.Scope) error {
	out.NodeAddress = in.NodeAddress
	out.NodeSecret = in.NodeSecret
	return nil
}

// Convert_config_UserAddressSecretMap_To_v1_UserAddressSecretMap is an autogenerated conversion function.
func Convert_config_UserAddressSecretMap_To_v1_UserAddressSecretMap(in *config.UserAddressSecretMap, out *UserAddressSecretMap, s conversion.Scope) error {
	return autoConvert_config_UserAddressSecretMap_To_v1_UserAddressSecretMap(in, out, s)
}
