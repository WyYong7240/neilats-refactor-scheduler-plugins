...
import (
	"os"
	neilatsScheduler "sigs.k8s.io/scheduler-plugins/pkg/neilats_refactor_go"
...
func main() {
	...
	command := app.NewSchedulerCommand(
		...
		//app.WithPlugin(customsp.Name, customsp.New),
		app.WithPlugin(neilatsScheduler.Name, neilatsScheduler.New),
	)
